...
export const Navbar = () => {
  ...
  return (
    <div className="navbar">
      ...
      <div >
        ...
        {!isLoggedIn && (<>
          ...
          <div className="navegador">
            <ul className="ysi">
              <ul ><a className="links" href="/">Home</a></ul>
              <ul><a className="links" href="/sign-in">Logearse</a></ul>
              <ul><a className="links" href="/sign-up">Registrarse</a></ul>
            </ul>
          </div>
        </>)}
      </div>
      ...
      <div className="navegador">
        <ul className="ysi">
          <ul><a className="links" href="/generate-invitation">Home</a></ul>
          <ul><a className="links" href="/create-notification">Logearse</a></ul>
          <ul><a className="links" href="/sign-up">Registrarse</a></ul>
        </ul>
      </div>
